...
var color_fuente_titulo = 'gold'

var color_fondo = 'white'

var color_fuente_clave = 'white'
...
function IniciaBuscador(palabraClave, paginacion, nuevaBusqueda) {
	...
	if ( palabraClave == "" ) {
		alert("¡Introduzca cadena de busqueda!")
		return
	}
	...
	CreaCabecera('<tr><td><p>Resultados de la busqueda</p></td>')

	if (totales != 0)
		Pagina += '<td><p>Se han encontrado ' + totales + ' resultados que contienen la palabra <b class="clave">' + palabraClave + '</b>:</p>\n</td>'
	else
		Pagina += '<td><p>No se han encontrado resultados para la palabra <b class="clave">' + palabraClave + '</b>.</p>\n</td>'
	
	Pagina += '<td><table width="80%">' + resultados + '</table>'
